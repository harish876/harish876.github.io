...
date: "2025-03-08"
excerpt: "In this install of Tools, Terminal and TCP we build a Web server from scratch, HTTP request parsing, routing using radix trees and more"
published: true
---
...
![Accurate representation of myself](/img/http-blog.jpg)

*Accurate representation of me, writing that joke*
